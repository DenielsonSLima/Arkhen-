...
const MENU_ITEMS = {
  ...
  'simulacoes-calculos': { id: 'simulacoes-calculos', label: 'Simulações e Cálculos', icon: Calculator },
  ...
  protocolos: { id: 'protocolos', label: 'Protocolos e Documentos', icon: FileCheck },
