...
const HELP_DATA: HelpModule[] = [
  ...
  },
  {
    ...
    submodulos: [
      { nome: 'Folha e encargos', descricao: 'Cálculo de proventos, descontos e custo trabalhista.', comoUsar: 'Use para conferência técnica antes de registrar lançamentos.' },
...
interface GuiaDeAjudaProps {
  onClose: () => void;
}

export const GuiaDeAjuda: React.FC<GuiaDeAjudaProps> = ({ onClose }) => {
  return (
    <div className="help-modal-backdrop" onClick={onClose}>
      <div className="help-modal-card" onClick={(event) => event.stopPropagation()} role="dialog" aria-label="Guia do sistema" aria-modal="true">
        <div className="help-modal-header">
          <h2>Guia de Navegação do Sistema</h2>
          <p>Manual rápido para o contador iniciar, usar os módulos e localizar funcionalidades.</p>
          <button className="help-close-btn" onClick={onClose} title="Fechar">
            ×
          </button>
        </div>
        ...
        <div className="help-modal-content">
          ...
          <section className="help-grid">
            {HELP_DATA.map((module) => (
              <article key={module.titulo} className="help-module-card">
