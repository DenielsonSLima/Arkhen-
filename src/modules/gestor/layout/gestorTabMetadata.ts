export const TAB_INFOS: Record<string, { title: string; iconName: string }> = {
  ...
  'parametrizacao-parametros-calculo': { title: 'Rescisão', iconName: 'FileX2' },
  ...
  'parametrizacao-checklists': { title: 'Modelos de fechamento', iconName: 'ClipboardList' },
  ...
  'atividades-modelos': { title: 'Rotinas programadas', iconName: 'Repeat' },
  ...
  'atividades-rotinas': { title: 'Rotinas programadas', iconName: 'Repeat' },
