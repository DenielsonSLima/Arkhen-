...
type AddOutrosDebitosModalProps = {
  isOpen: boolean;
  onClose: () => void;
...
export const AddOutrosDebitosModal: React.FC<AddOutrosDebitosModalProps> = ({
  isOpen,
  onClose,
  onSubmit,
  isLoading,
  ...
  const [categoria, setCategoria] = useState('Custos');
      ...
      <div className="faturamento-card faturamento-charge-modal" style={{ maxWidth: '600px' }}>
        ...
        <div className="faturamento-modal-header">
          <div className="faturamento-modal-title-wrap">
            ...
            <div>
              <h2>Novo débito (Despesa)</h2>
              <p>Registre saídas avulsas, taxas ou tarifas descontadas direto em conta.</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="faturamento-charge-form">
          ...
          <div className="faturamento-form-group">
            <label>Valor (R$)</label>
            <div className="faturamento-input-with-icon" style={{ borderLeft: '4px solid #ef4444' }}>
              <DollarSign size={16} />
              <input
                type="text"
                required
          ...
          <div className="faturamento-form-group" style={{ gridColumn: '1 / -1' }}>
            ...
            <div className="faturamento-input-with-icon">
              ...
              <input
                type="text"
                required
                placeholder="Digite a descrição do débito..."
                value={descricao}
          ...
          <div className="faturamento-form-group">
            ...
            <div className="faturamento-input-with-icon">
              ...
              <select value={categoria} onChange={(e) => setCategoria(e.target.value)} required>
                ...
                <option value="Taxa Bancária">Taxas e Tarifas Bancárias</option>
                <option value="Operacional">Outras Despesas Operacionais</option>
              </select>
            </div>
          </div>
          ...
          <div className="faturamento-modal-actions" style={{ gridColumn: '1 / -1', display: 'flex', justifyContent: 'flex-end', gap: '12px', marginTop: '16px', borderTop: '1px solid #cbd5e1', paddingTop: '16px', background: 'transparent' }}>
            ...
            >
              {isLoading ? 'Registrando...' : 'Confirmar Débito'}
            </button>
          </div>
