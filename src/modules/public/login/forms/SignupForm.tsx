  ...
  return (
    <div className="signup-page-card animate-fade-in">
      ...
      <div className="signup-page-footer">
        ...
        <div className="developer-signature" style={{ position: 'relative', right: 0, bottom: 0, marginTop: '24px' }}>
          <img src={signatureLogoImg} alt="DAILABS" className="developer-signature-icon" />
          <div className="developer-signature-copy">
            <span className="developer-signature-brand">DAILABS</span>
            <span className="developer-signature-text">CREATIVE AI & SOFTWARE</span>
          </div>
        </div>
      </div>
    </div>
