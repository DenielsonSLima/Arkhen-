...
import { usePublicSharedPage } from './hooks/usePublicSharedPage';
...
export const PublicSharedDocumentPage: React.FC = () => {
  const { isLoading, shareData, isExpired, isUnlocked, handleUnlock, passwordError, isSingleFile, activeDocument, documents, totalSizeFormatted, toggleSelection, setActiveId, documentUrls, setPreviewError, previewError, remainingLabel, isBatchDownloading, handleDownloadOne, handleDownloadSelected, handleDownloadAll, canDownloadAll } = usePublicSharedPage();
