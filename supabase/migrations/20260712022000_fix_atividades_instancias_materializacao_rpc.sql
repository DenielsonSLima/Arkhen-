-- Corrige a RPC de materializacao das atividades por empresa.
-- A versao anterior referenciava o alias do UPDATE dentro do JOIN do FROM,
-- o que deixava a RPC indisponivel no PostgREST.
...
BEGIN
  ...
  WHERE ai.empresa_id = v_empresa_id
    ...
    AND ai.modelo_id = am.id
    AND c.empresa_id = v_empresa_id
    AND am.empresa_id = v_empresa_id
    AND ai.ativo = true
